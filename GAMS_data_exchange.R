# igdx("C:/GAMS/win64/24.8") # Already in function definitions


### Run Food_init.R before this!!
source("Food_init.R")
...
# Which RDA threshold scenario to run
load(file="kg_by_cls_90RDA.Rda")
# load(file="kg_by_cls_100RDA.Rda")

nutr <- food_nutrients  # food_nutrients_org
...
scenarios_main_90RDA <- scenarios
...
save(scenarios_main_90RDA, file=paste0(gamsdir,'scenarios_main_90RDA.Rda'))

save(scenarios_main, file=paste0(workdir,'diet_gms/scenarios_main.Rda'))
save(scenarios_main_prc, file=paste0(workdir,'diet_gms/scenarios_main_prc.Rda'))
save(scenarios_main_frt, file=paste0(workdir,'diet_gms/scenarios_main_frt.Rda'))
save(scenarios_rice_sens, file=paste0(workdir,'diet_gms/scenarios_rice_sens.Rda'))
save(scenarios_main_devmin, file=paste0(workdir,'diet_gms/scenarios_main_devmin.Rda'))
load(file=paste0(gamsdir,'scenarios_main.Rda'))
...
wgdx(paste0(interim_path, "DLE_data_hh.gdx"), f, a, pr, c, e, r, nn)  # Running files in old repository.. (not optimal but syncing these is a pain in the ass.)
